...
function Navbar() {
  ...
  return (
    <nav className="relative bg-white dark:bg-primary-dark after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
